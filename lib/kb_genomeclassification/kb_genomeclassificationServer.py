...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_genomeclassification'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_genomeclassification.kb_genomeclassificationImpl import kb_genomeclassification  # noqa @IgnorePep8
impl_kb_genomeclassification = kb_genomeclassification(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_genomeclassification'
        ...
        self.rpc_service.add(impl_kb_genomeclassification.build_classifier,
                             name='kb_genomeclassification.build_classifier',
                             types=[dict])
        self.method_authentication['kb_genomeclassification.build_classifier'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_genomeclassification.predict_phenotype,
